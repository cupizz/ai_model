...
def train_model_background_task(*args, **kwargs) -> str:
    try:
...
def train_model_thread(*args, **kwargs) -> str:
    try:
        th = threading.Thread(target=train_model_clustering, args=args, kwargs=kwargs)
        th.start()
